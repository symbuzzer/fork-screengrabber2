...
_LIT(KSGTemporaryDirectory, "\\system\\temp\\screengrabber2\\");
...
_LIT(KSettingsFileName, "screengrabber2_settings.ini");
...
void CScreenGrabberModel::LoadSettingsL()
	...
	LoadDFSValueL(settingsStore, KSGSettingScreenDevice,                            iGrabSettings.iScreenDevice);
...
void CScreenGrabberModel::SaveSettingsL(TGrabSettings aGrabSettings)
	...
	SaveDFSValueL(settingsStore, KSGSettingScreenDevice,                             iGrabSettings.iScreenDevice);
